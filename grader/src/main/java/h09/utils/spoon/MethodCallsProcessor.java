...
public class MethodCallsProcessor extends AbstractProcessor<CtClass<?>> {
    ...
    /**
     * Constructs and initializes a processor which scans all calees in the specified method.
    ...
    /**
     * Returns the scanned callees so far. If this processor does not process any method
