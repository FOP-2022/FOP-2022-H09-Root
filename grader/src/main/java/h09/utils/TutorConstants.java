...
public final class TutorConstants {
   ...
   */
  public static final String H1_1_FIELD_TYPE_PARAMETER_3 = "Z, ? super Y, Z";
  /**
   ...
   */
  public static final String H1_4_FIELD_TYPE_PARAMETER = "Y, ? super Y, Y";
  ...
  public static final String[] H1_6_METHOD_1_LAMBDAS = {
    ...
    "java.util.function.BiFunction<java.lang.Integer, ? super java.lang.Integer, java.lang" +
      ".Integer>"
  };
  /**
